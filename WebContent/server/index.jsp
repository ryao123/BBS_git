...
<body>
    ...
    <div class="container">
        ...
        <c:set value="${userId }"  var="user"></c:set>
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              ...
              <dd><a href="Login?lo=loginOut">退出</a></dd>
            </dl>
          </li>
      ...
      <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li date-refresh="1">
                        <a _href="UserServlet?op=findAll">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户列表</cite>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="InvitationServlet?op=findAll">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>帖子列表</cite>
                        </a>
                    </li >
